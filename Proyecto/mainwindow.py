...
class MainWindow( QMainWindow ):
    ...
    def click_mostrar_tabla(self):
        self.ui.tabla.setColumnCount(11)
        headers = ['ID','Origen x', 'Origen y', 'Destino x', 'Destino y', 'Velocidad', 'Red', 'Green','Blue', 'Distancia', 'Determinante']
        ...
        for particula in self.particulas:
            ...
            determinante = QTableWidgetItem(str(particula.determinante))
            ...
            self.ui.tabla.setItem(row, 10, determinante)
    ...
    def click_buscar(self):
        ...
        for particula in self.particulas:
            if id == str(particula.id):
                ...
                self.ui.tabla.setItem(0, 10, determinante)
